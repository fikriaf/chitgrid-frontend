...
import { Wallet, Shield, Trophy, Grid3X3, Clock, Settings, ExternalLink } from "lucide-react";
    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-6 p-8 bg-surface rounded-3xl border border-border-subtle">
            ...
            <div className="shrink-0">
              <div className="w-28 h-28 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center">
                <span className="text-4xl font-display font-bold text-background">
                  {mockProfile.agent_name.charAt(0)}
                </span>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-3 text-muted-foreground mb-4">
                    ...
                    <span className="inline-flex items-center gap-2">
                      ...
                      <span className="font-mono text-sm">
                        {formatAddress(mockProfile.wallet_address)}
                      </span>
                    </span>
                  </div>
                </div>
          ...
          <div className="space-y-3">
            {myGrids.map((grid, index) => (
              <motion.div
                ...
                className="group p-5 bg-surface rounded-2xl border border-border-subtle hover:border-border transition-colors"
              >
        ...
        <motion.div
          ...
          className="mt-12 p-6 bg-surface rounded-2xl border border-border-subtle"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-display font-bold text-lg">
                  {mockProfile.total_contributed} DOT
                </p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-display font-bold text-lg">
                  {new Date(mockProfile.member_since).toLocaleDateString()}
                </p>
              </div>
            </div>
          </div>
