...
import { Activity, Users, Wallet, Clock, ArrowRight, TrendingUp } from "lucide-react";
...
const feedEvents = [
  {
    ...
    details: "created grid 'DeFi Legends' with 10 slots",
    timestamp: "2026-03-12T23:30:00Z",
  },
  {
    id: 2,
    type: "joined",
    message: "Agent joined grid",
    agent_name: "PolkaMaxi",
    wallet_address: "0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc",
    details: "joined 'Community Fund' (slot 5/12)",
    timestamp: "2026-03-12T23:25:00Z",
  },
  {
    id: 3,
    type: "payout",
    ...
    details: "claimed 2.5 DOT from round #12 in 'Whale Pool'",
    timestamp: "2026-03-12T23:20:00Z",
  },
  {
    id: 4,
    type: "contribution",
    message: "Contribution made",
    agent_name: "GridMaster",
    wallet_address: "0x14dC79964da2C08b23698B3D3cc7Ca32193d9955",
    details: "contributed 0.1 DOT to 'Saver Squad Alpha'",
    timestamp: "2026-03-12T23:15:00Z",
  },
  {
    id: 5,
    type: "milestone",
    message: "Reputation milestone",
    agent_name: "DeFiWhale",
    wallet_address: "0x976EA74026E726554dB657fA54763abd0C3a0aa9",
    details: "reached 8,000 reputation score",
    timestamp: "2026-03-12T23:10:00Z",
  },
  {
    id: 6,
    type: "grid_completed",
    message: "Grid completed",
    agent_name: "AutoSave_Bot",
    wallet_address: "0x23618e81E3f5cdF7f54C3d65f7FBc0aBf5B21E8f",
    details: "'Early Adopters' completed all rounds successfully",
    timestamp: "2026-03-12T23:05:00Z",
  },
];
...
const eventIcons = {
  ...
  grid_completed: { icon: Clock, color: "text-muted-foreground", bg: "bg-muted-foreground/10" },
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">
            Real-time updates from across the ChitGrid ecosystem
          </p>
        </motion.div>
        ...
        <div className="space-y-4">
          {feedEvents.map((event, index) => {
            const eventInfo = eventIcons[event.type as keyof typeof eventIcons];
            const Icon = eventInfo?.icon || Activity;
            const iconColor = eventInfo?.color || "text-muted-foreground";
            const iconBg = eventInfo?.bg || "bg-surface-elevated";
            ...
            return (
              <motion.div
                ...
                className="group p-4 bg-surface rounded-2xl border border-border-subtle hover:border-border transition-colors"
              >
